...
def parser_agent(ctx: dict[str, Any]) -> AgentOutput:
    ...
    from contract_agent.llm.agent_prompts import parser_prompt
...
def risk_checker_agent(ctx: dict[str, Any]) -> AgentOutput:
    ...
    from contract_agent.llm.agent_prompts import risk_checker_prompt
    from contract_agent.llm.client import get_chat_model
...
def redrafter_agent(ctx: dict[str, Any]) -> AgentOutput:
    ...
    from contract_agent.llm.agent_prompts import redrafter_prompt
    from contract_agent.llm.client import get_chat_model
